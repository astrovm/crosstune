...
- `app/src/main/java/com/astrolabs/crosstune/MainActivity.kt`: main app flow and UI entry point.
- `app/src/main/java/com/astrolabs/crosstune/ui/theme/*`: Compose theme setup.
